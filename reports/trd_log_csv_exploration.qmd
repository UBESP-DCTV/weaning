...
Da protocollo dello studio, un SBT viene tentato quando sussistono contemporaneamente due condizioni:
...
weaning_days %>%
  ...
  group_by(id_univoco) %>%
  summarise( SBT_per_paziente = n()) %>%
  group_by(SBT_per_paziente) %>%
...
Si prendano come esempio i tre pazienti analizzati precedentemente: TS012, BS003 e NO004, dei quali abbiamo registrati come SBT i seguenti
