...
-   il paziente NO021 ha registrate delle estubazioni senza essere mai stato "ready"

-   mentre gli altri dati sono plausibili per quanto improbabili
...
-   lavoro respiratorio del ventilatore \[BLU\] (del pz è meno rilevante) \[NERO\]

-   pressione di picco delle vie aeree

-   pressione media delle vie aeree \[ARANCIO\]

-   pressione di fine espirazione \[VERDE\]
...
Si rivedono ora le tre strategie, evidenziando le modifiche che ci si attende dai tracciati o dai log:
